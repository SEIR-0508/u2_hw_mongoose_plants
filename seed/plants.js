...
const run = async () => {
    // once all the plants have beein inserted 
    await main()
    // close the database connection
    db.close()
}

// initiates the execution of the script
// starts the process of calling main, closing the database conection, and then running script
run()


// sets up asynchronous function 'main' that is responsible for inserting plant data
// defines another asynchronous function 'run' that calls main and closes the database connection
// last run() initiates the execution of the main logic of applciation (inserting plants into db and closing the db connection)